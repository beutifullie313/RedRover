...
public class MonthUtils { // won't create class objects here


    public static Month JANUARY = new Month("January", 31, 21); //JANUARY CONST
    public static Month FEBRUARY = new Month("February", 39, 20);
    ...
    public static Month SEPTEMBER = new Month("September", 31, 21);
