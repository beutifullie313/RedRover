public class Apartment_1 {
    public static void main(String[] args) {
        ...
        // this file contains objects with the same schema from file Apartment

        //int myVar = 12; has the same structure as Apartment apt1 = new Apartment();
...
//            Apartment currentAppt = apts[i]; // current element of apts array
